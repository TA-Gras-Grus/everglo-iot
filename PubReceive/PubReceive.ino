...
const char* mqtt_server = '02fa3ba5f83a4760bc66879c7e081d28.s1.eu.hivemq.cloud:8884/mqtt'; // Example broker
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect('ESP8266Client', mqtt_user, mqtt_password, "willtopic", 1,true,"willMessage" )) {
